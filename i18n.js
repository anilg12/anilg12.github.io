...
const TRANSLATIONS = {
  tr: {
    ...
    "proj.tagline": "Tam-yığın bir stok motoru — önce masaüstü olarak inşa edildi, sonra web'e açıldı.",
    "proj.desc": "Akademik bir projeden başlayan, küçük bir işletmenin stoğunu nasıl yönettiğine dair pragmatik bir çalışmaya dönüşen ürün. OptiStock; bir Flet masaüstü istemcisi, yerel bir SQLite veritabanı ve temiz bir Python servis katmanını birleştirir — yerli hissetmek, çevrimdışı çalışmak ve sonraki geliştirici için okunabilir kalmak ve çevrimiçi ortamda geliştirilebilir olabilmesi amacıyla tasarlandı.",
    "proj.role": "Rol", "proj.role_v": "Tek başına geliştirme",
    "proj.year": "Yıl",
    "proj.scope": "Kapsam", "proj.scope_v": "Masaüstü + Web",
    "proj.stack": "Yığın",
    "proj.data": "Veri",
    "proj.status": "Durum", "proj.status_v": "v1 · yayında",
    "proj.kpi1": "Aktif SKU",
    "proj.kpi2": "Ort. yanıt",
    "proj.kpi1_trend": "↑ %4.2 bu hafta",
    "proj.kpi2_trend": "SQLite · yerel",
    "proj.chart_label": "Stok hareketi · 24s",
    ...
    "contact.ch_github": "/ GitHub · portfolyo",
  ...
  en: {
    ...
    "proj.tagline": "A full-stack inventory engine — built desktop-first, then unfolded to web.",
    "proj.desc": "An academic-led project that turned into a pragmatic study of how a small business actually moves stock. OptiStock combines a Flet desktop client, a local SQLite store, and a clean Python service layer — designed to feel native, run offline, stay readable for the next developer who opens it, and be extensible in an online environment.",
    "proj.role": "Role", "proj.role_v": "Solo build",
    "proj.year": "Year",
    "proj.scope": "Scope", "proj.scope_v": "Desktop + Web",
    "proj.stack": "Stack",
    "proj.data": "Data",
    "proj.status": "Status", "proj.status_v": "v1 · shipped",
    "proj.kpi1": "Active SKUs",
    "proj.kpi2": "Avg. response",
    "proj.kpi1_trend": "↑ 4.2% this week",
    "proj.kpi2_trend": "SQLite · local",
    "proj.chart_label": "Stock movement · 24h",
    ...
    "contact.ch_github": "/ GitHub · portfolio",
