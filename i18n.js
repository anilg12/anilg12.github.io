...
const TRANSLATIONS = {
  tr: {
    ...
    "contact.ch_cv_value": "Word belgesi (.docx) — Türkçe",
    "contact.cv_href": "cv/Anil-Gul-CV-TR.docx",
  ...
  en: {
    ...
    "contact.ch_cv_value": "Word document (.docx) — English",
    "contact.cv_href": "cv/Anil-Gul-CV-EN.docx",
